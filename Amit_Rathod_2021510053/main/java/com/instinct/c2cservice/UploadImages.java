...
public class UploadImages extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButtonUpload.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                String description = mEditTextFileName.getText().toString();

                if(description.isEmpty()){
                    Toast.makeText(UploadImages.this, "Add Description ", Toast.LENGTH_SHORT).show();
            ...
            mUploadTask = fileReference.putFile(mImageUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(UploadImages.this, "Upload successful", Toast.LENGTH_LONG).show();
    ...
    public void onBackPressed() {
        ...
        Intent i = new Intent(UploadImages.this, SPmainActivity.class);
        startActivity(i);
        finish();
