...
def login_mail():
    ...
    try:
        ...
        texttospeech("Trying to login", file + i)
        i = i + str(1)
        return JsonResponse({'result': 'failure'})
"""
imap_url = 'imap.gmail.com'
    ...
    if request.method == 'POST':
        ...
        while (flag):
            ...
            if act == 'search':
                ...
                passwrd = ""
                texttospeech(
                    "You have been logged out of your account thank you for using voice gmail.",
                    file + i)
                i = i + str(1)
                return JsonResponse({'result': 'logout'})
